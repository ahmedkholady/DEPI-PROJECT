            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10">
                <div className="text-center lg:text-left max-w-xl">
                    ...
                    <p className="text-gray-700 text-base sm:text-lg mb-6">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, natus quo? Odit reiciendis 
                        pariatur cumque voluptatum cum repellat soluta aspernatur,
                    </p>
                    <div className="flex justify-center lg:justify-start gap-4">
                        <a href="#products"
                        className="px-6 py-3 bg-pink-900 text-white text-sm font-semibold
                        rounded-lg shadow hover:bg-pink-600 transition"
                        >Shop Now</a>
                        <a href="#offers"
